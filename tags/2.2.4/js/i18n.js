...
Lang.prototype.notifSet = {
    'FALLBACK': {
        ...
        'MULTI-MANUAL': 'Mutiple enabled manual rules (Only the \
first will be used)!',
        ...
        'RULE-RESTORE-ERR': "Unable to restore! Please check the \
text",
        'URL-INVALID-PROTO': 'Invalid protocol, did you left out \
http:// or something?',
    },
    ...
    'zh-CN': {
        ...
        'URL-INVALID-PROTO': '协议不存在，遗漏了诸如http://之类的？',
    },
};
