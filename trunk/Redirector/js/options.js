...
function ruleList() {
/**
 * Array "ruleList.data" contains several other arrays called "rules".
 * The first rule is an empty rule, so the actual rules start from
 * Index 1.
 *
...
ruleList.prototype.save = function() {
    ...
    if(typeof(whitelist) == 'undefined' ||
       ...
       typeof(subStr) == 'undefined' || ruleName == '' ||
       repl == '' || testUrl == '') {
...
ruleList.prototype.onSel = function(e) {
    ...
    if(e instanceof Object) {
        ...
        var elem
            = ruleListTable.getElementsByTagName('tr')[ruleListSel];
    }
